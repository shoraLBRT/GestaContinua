...
namespace GestaContinua.Infrastructure.Repositories
{
    public class EfTaskRepository : ITaskRepository
    {
        ...
        public async Task<IEnumerable<Domain.Entities.Task>> GetActiveByUserIdAsync(Guid userId)
        {
        ...
        public async Task<IEnumerable<Domain.Entities.Task>> GetWithRemindersDueAsync(DateTime now)
        {
            return await _context.Tasks
        ...
        public async Task<IEnumerable<Domain.Entities.Task>> GetAllByUserIdAsync(Guid userId)
        {
            return await _context.Tasks
